...
from PySide6.QtGui import QPainter, QFont, QSyntaxHighlighter, QTextCharFormat, QTextCursor, QTextDocument
...
class QPygmentsHighlighter(QSyntaxHighlighter):
	...
	def __init__(self, parent: Union[QObject, QTextDocument], lang: str):
...
class QCodeEditor(QPlainTextEdit):
	...
	def __init__(self, DISPLAY_LINE_NUMBERS=True, HIGHLIGHT_CURRENT_LINE=True,
				 SyntaxHighlighter=QPygmentsHighlighter, lang="python", font_size=11, delimeter="    ", *args):
